...
namespace PuzzleBattle.Editor
{
    ...
    public static class SampleSceneCanvasSetupUtility
    {
        ...
        private static void SetupScene(Scene scene)
        {
            ...
            Text roundLabel = FindOrCreateText(topUiRoot, "RoundLabel", font, 34, FontStyle.Bold, TextAnchor.UpperLeft, new Color(1f, 0.97f, 0.88f, 1f), "Round 1");
            Text timerLabel = FindOrCreateText(topUiRoot, "TimerLabel", font, 22, FontStyle.Normal, TextAnchor.UpperLeft, new Color(0.85f, 0.92f, 1f, 0.92f), "Timer 20.0s");
            Text statusLabel = FindOrCreateText(topUiRoot, "StatusLabel", font, 22, FontStyle.Normal, TextAnchor.UpperLeft, new Color(1f, 1f, 1f, 0.9f), "Pick a skill to begin.");
            Text skillsLabel = FindOrCreateText(topUiRoot, "SkillsLabel", font, 20, FontStyle.Bold, TextAnchor.LowerLeft, new Color(1f, 0.95f, 0.8f, 0.95f), "Status");
            Text comboLabel = FindOrCreateText(uiRoot, "ComboLabel", font, 28, FontStyle.Bold, TextAnchor.MiddleCenter, new Color(1f, 1f, 1f, 0.82f), "Select a skill to start the round.");
            ...
            Text coinLabel = FindOrCreateText(coinHudRoot, "CoinLabel", font, 24, FontStyle.Bold, TextAnchor.MiddleLeft, new Color(1f, 0.94f, 0.72f, 1f), "코인 0");
            ...
            Text playerHealthLabel = FindOrCreateText(playerHealthRoot, "Label", font, 18, FontStyle.Bold, TextAnchor.MiddleCenter, new Color(1f, 0.95f, 0.92f, 1f), "HP 500/500");
            ...
            for (int i = 0; i < skillCards.Length; i++)
            {
                ...
                Text title = FindOrCreateText(root, "Title", font, 26, FontStyle.Bold, TextAnchor.UpperCenter, Color.white, "Skill Title");
                Text description = FindOrCreateText(root, "Description", font, 18, FontStyle.Normal, TextAnchor.UpperCenter, new Color(1f, 1f, 1f, 0.82f), "Skill description");
                Text action = FindOrCreateText(root, "Action", font, 18, FontStyle.Bold, TextAnchor.LowerCenter, new Color(1f, 0.95f, 0.72f, 1f), "획득");
        ...
        private static PuzzleBattleUiDocument.HudButtonSlot CreateHudButton(Transform parent, Font font, string id, string labelText, Vector2 anchoredPosition, Color backgroundColor)
        {
            ...
            Text label = FindOrCreateText(root, "Label", font, 18, FontStyle.Bold, TextAnchor.MiddleCenter, Color.white, labelText);
        ...
        private static Text FindOrCreateText(Transform parent, string name, Font font, int fontSize, FontStyle fontStyle, TextAnchor alignment, Color color, string textValue)
        {
